$(document).on('ready', function() {
	...
	$("#mce-LNAME").keypress(function() {
           $('#mce-LNAME').removeClass('place_error errorClass');
		   $("#mce-LNAME").css("border-color", "");
    });
	...
	$("#mc-embedded-subscribe-form").on("submit", function(event) { 
		...
		if( fname == '' &&  email == ''  ){	
			$("#mce-FNAME").attr('placeholder' , 'Please Enter Your Name');
			 ...
			 $("#mce-LNAME").attr('placeholder' , 'Please Enter Your Last Name');
			 $('#mce-LNAME').addClass('place_error errorClass');
